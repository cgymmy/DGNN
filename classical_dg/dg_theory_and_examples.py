...
现有代码实现：
- classical_dg/dg_solver.py : 统一的DG求解器框架
- src/problems/poisson1d_dg.py : 1D Poisson DG-Net求解器
- src/problems/poisson2d_dg.py : 2D Poisson DG-Net求解器
- src/problems/burgers_dg.py : 1D Burgers DG-Net求解器
...
from classical_dg.dg_solver import Poisson1D_DG, Poisson2D_DG
